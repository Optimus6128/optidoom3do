...
extern Word ScreenWidthUnscaled;	/* True Width of the view screen (before screen scale)*/
extern Word ScreenHeightUnscaled;	/* True Height of the view screen (before screen scale)*/
...
extern Word ScreenXOffsetUnscaled;	/* True X coord for projected screen (before screen scale)*/
extern Word ScreenYOffsetUnscaled;	/* True Y coord for projected screen (before screen scale)*/
...
extern void DrawFlatWallColumn(Word y,Byte *Source);
extern void DrawFloorColumn(Word ds_y,Word ds_x1,Word Count,LongWord xfrac, LongWord yfrac,Fixed ds_xstep,Fixed ds_ystep);
extern void DrawFlatFloorColumn(Word ds_y, Word ds_x1, Word length);
